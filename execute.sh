...
# export exp="ensemble_ldm_vq_128_128_128"
# export exp="brats21_subclass/876c_10f/0000"
# export exp="test"


mkdir -p ./runs/$exp; sbatch -D $(pwd) -J $exp -o ./runs/$exp/slurm_out_$2.txt -p smart_health_02 -N 1 -n 1 --cpus-per-task=$(($ngpus*4)) --gpus=$ngpus --mem=$(($ngpus*48))G ./run/run_template.sh ${@:2}