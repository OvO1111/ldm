...
from ldm.models.diffusion.sampling.helpers.solver import DDIMStepSolver, MultiDiffStepSolver


class DDIMSampler(object):
    def __init__(self, model, schedule="linear",
                 score_corrector_config=None,
                 use_multi_diffusion=False, **kwargs):
        super().__init__()
        self.model = model
        self.schedule = schedule
        self.ddpm_num_timesteps = model.num_timesteps
        
        self.use_multi_diffusion = use_multi_diffusion
        ...
        self.step_solver = partial(DDIMStepSolver if not self.use_multi_diffusion else MultiDiffStepSolver, **kwargs)
    ...
    def ddim_sampling(
        ...
        **kwargs
        ...
        for i, step in enumerate(iterator):
            ...
            img, pred_x0 = self.ddim_solver.step(img, cond, **kwargs)
