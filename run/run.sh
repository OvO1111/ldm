...
# exp="brats21_cvae_kl_128_128_128"
...
# exp="ruijin_vae_kl_96_192_192"
# mkdir -p ./runs/$exp; sbatch -D /ailab/user/dailinrui/code/latentdiffusion -N 1 -n 24 --gres=gpu:$ngpu -p smart_health_02 -A smart_health_02 -o ./runs/$exp/slurm_out.txt ./run/ruijin_vae_kl.sh $exp $ngpu $igpus
...
exp="ruijin_cdm_96_192_192"
mkdir -p ./runs/$exp; sbatch -D /ailab/user/dailinrui/code/latentdiffusion -N 1 -n 24 --gres=gpu:$ngpu -p smart_health_02 -A smart_health_02 -o ./runs/$exp/slurm_out.txt -J $exp ./run/ruijin_cdm.sh $exp $ngpu $igpus